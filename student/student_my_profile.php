...
$stmt = $connection->prepare("SELECT student_id, email, first_name, middle_name, last_name, profile_picture FROM tbl_student WHERE student_id = ? AND status = 'active'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update student_name after changing first/last name
    $student_name = trim($new_first_name . ' ' . $new_last_name);
                    ...
                    <form id="updateProfileForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="middle_name" name="middle_name" value="<?php echo htmlspecialchars($middle_name); ?>" readonly>
                            </div>
                            <div class="col-md-4">
