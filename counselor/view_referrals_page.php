...
// Main query to fetch referrals - Modified to show grouped referrals
$query = "SELECT 
            r.*, 
...
<head>
    ...
    <title>View Referrals - Counselor</title>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['student_info']); ?></td>
                                ...
                                <td>
                                    <a href="view_referral_details.php?id=<?php echo $row['id']; ?>" 
                                       class="btn btn-primary btn-sm-2"><i class="fas fa-eye p-1"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center">
                                <div class="alert alert-info" style="margin-top: 20px;">
                                    <i class="fas fa-info-circle"></i> There are no referrals to display.
                                    <?php 
                                    // Add context to the no records message based on applied filters
                                    $context_message = "All referrals have been processed";
