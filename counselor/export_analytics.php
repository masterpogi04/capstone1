    ...
    if ($format === 'csv') {
        ...
        <head>
            ...
            <style>
                ...
                .letterhead-text {
                    text-align: center;
                    line-height: 0.9; /* Reduced from 1.3 */
        ...
        foreach ($referrals as $referral) {
            $html .= '
                    <tr>
                        <td class="date-col">' . date('M j, Y', strtotime($referral['date'])) . '</td>
        ...
        $html .= '
            ...
            <div class="footer">
                Generated by University Guidance Counselor - ' . date('M j, Y') . '
            </div>
        </body>
        </html>';
