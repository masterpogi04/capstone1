...
<div class="sidebar">
    ...
    <nav>
        <ul>
            <li>
                <a href="facilitator_homepage.php"><i class="fas fa-home"></i> Home</a>
            </li>
            <li>
                <a href="facilitator_dashboard.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            </li>
            <li>
                <a href="facilitator_my_profile.php"><i class="fas fa-user"></i> My Profile</a>
            </li>
            <li>
                <a href="help_support_facilitator.php"><i class="fas fa-question-circle"></i> Help & Support</a>
            </li>
            <li>
