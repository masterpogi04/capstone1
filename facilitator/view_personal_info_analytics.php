...
$(document).ready(function() {
        ...
        if (departmentId) {
            ...
            $.ajax({
                ...
                success: function(courses) {
                    ...
                    // Apply filters after courses are loaded
                    applyFilters();
                },
                error: function(xhr, status, error) {
    ...
    // Course selection change automatically applies filters
    $('#courseSelect').change(function() {
        applyFilters();
    });

    // Handle checkbox changes - automatically apply filters
    ...
    $('#resetFilters').click(function() {
        ...
        // Reset checkboxes
        $('#genderCheck, #civilStatusCheck, #ageCheck, #yearLevelCheck').prop('checked', true);
        
        // Show all containers
        $('#genderContainer, #civilStatusContainer, #ageContainer, #yearLevelContainer').removeClass('hidden');
