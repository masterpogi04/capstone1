        ...
        <tr>
            <td width="50%">
                ...
                <div style="width: 100%; margin-top: 5px;">
                    <div style="width: 100%; border-bottom: 1px solid black; text-align:center; margin-top: 5%;">' .(new DateTime($report['date_reported']))->format('M j, Y') .  '</div>
                </div>
            </td>
            <td width="50%">
                ...
                <div style="width: 100%; margin-top: 5px;">
                    <div style="width: 100%; border-bottom: 1px solid black; text-align:center; margin-top: 5%;">' . htmlspecialchars($report['place']) . '</div>
                </div>
            </td>
        </tr>
        <tr>
