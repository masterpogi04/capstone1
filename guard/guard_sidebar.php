...
$stmt = $connection->prepare("SELECT username, first_name, middle_initial, last_name FROM tbl_guard WHERE id = ?");
...
<div class="sidebar">
    <div class="profile-section text-center">
        ...
        <h4 class="guard-name"><?php echo htmlspecialchars($display_name); ?></h4>
    </div>
    <nav>        
    <ul>
        <li <?php echo basename($_SERVER['PHP_SELF']) == 'guard_homepage.php' ? 'class="active"' : ''; ?>> 
            <a href="guard_homepage.php">
                <i class="fas fa-home"></i>
                <span>Home</span>
            </a>
        </li>
        <li <?php echo basename($_SERVER['PHP_SELF']) == 'guard_myprofile.php' ? 'class="active"' : ''; ?>>
            <a href="guard_myprofile.php">
                <i class="fas fa-user-circle"></i>
                <span>My Profile</span>
            </a>
        </li>
        <li <?php echo basename($_SERVER['PHP_SELF']) == 'help_support_guard.php' ? 'class="active"' : ''; ?>>
            <a href="help_support_guard.php">
