...
<div class="header">
    ...
    <i class="bi bi-file-earmark-text me-2"></i>Submit an Incident Report
</a>
    <a href="view_submitted_incident_reports-adviser.php" class="custom-btn">
        <i class="fas fa-file-alt"></i>View my Incident Report
    </a>
    <a href="view_student_incident_reports.php" class="custom-btn"><i class="fas fa-file-alt"></i>View my advise Incident Reports</a>
</div>
