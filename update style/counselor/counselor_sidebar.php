...
<div class="sidebar">
    <div class="profile-section text-center">
        ...
        <p class="counselor-name"><?php echo htmlspecialchars($name); ?></p>
    </div>
    <nav>
        <ul>
            <li>
                <a href="counselor_homepage.php"><i class="fas fa-home"></i> Home</a>
            </li>
            <li>
                <a href="counselor_myprofile.php"><i class="fas fa-user"></i> My Profile</a>
            </li>
            <li>
                <a href="help_support_counselor.php"><i class="fas fa-question-circle"></i> Help & Support</a>
            </li>
            <li>
