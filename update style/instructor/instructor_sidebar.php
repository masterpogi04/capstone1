...
$instructor_name = isset($_SESSION['name']) ? $_SESSION['name'] : 'Instructor';

if (!defined('UPLOADS_URL')) {
    define('UPLOADS_URL', '/capstone1/uploads/instructor_profiles/');
}
...
<div class="sidebar">
    <div class="profile-section text-center">
        ...
        <h4 class="instructor-name"><?php echo htmlspecialchars($name); ?></h4>
    </div>
