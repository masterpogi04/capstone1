...
function fetchAnalyticsData($connection, $departmentId = null, $courseId = null) {
    ...
    $queries = [
        ...
        // Career concerns query remains the same
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="filter-controls">
            ...
            <!-- Add Chart Toggle Controls -->
            <div class="row mt-3">
                <div class="col-12">
                    <div class="chart-toggles">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input chart-toggle" type="checkbox" id="toggleCourseFactors" checked data-target="courseFactorsContainer">
                            <label class="form-check-label" for="toggleCourseFactors">Course Selection Factors</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input chart-toggle" type="checkbox" id="toggleCareerConcerns" checked data-target="careerConcernsContainer">
                            <label class="form-check-label" for="toggleCareerConcerns">Career Concerns</label>
                        </div>
                        <button style= "margin-right: 100px;"id="applyFilters" class="btn btn-primary ml-3">Apply Filters</button>
                    </div>
                </div>
            </div>
        </div>
...
function showStudentDetails(category, value) {
    ...
    $.ajax({
        ...
        // In the success callback of getStudents AJAX call
...
$(document).ready(function() {
    ...
    $('.chart-toggle').change(function() {
        ...
        $(`#${targetId}`).toggleClass('hidden', !this.checked);
