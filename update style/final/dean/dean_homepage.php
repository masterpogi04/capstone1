...
$stmt = $connection->prepare("SELECT first_name, last_name, profile_picture FROM tbl_dean WHERE id = ?");
if ($stmt === false) {
...
// Fetch notifications for dean
$notifications_query = "SELECT * FROM notifications WHERE user_type = 'dean' AND is_read = 0 ORDER BY created_at DESC";
