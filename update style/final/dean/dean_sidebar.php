...
$dean_name = isset($_SESSION['name']) ? $_SESSION['name'] : 'Dean';

if (!defined('UPLOADS_URL')) {
    define('UPLOADS_URL', '/capstone1/uploads/dean_profiles/');
}
...
<div class="sidebar">
    <div class="profile-section text-center">
        ...
        <h4 class="dean-name"><?php echo htmlspecialchars($dean_name); ?></h4>
    </div>
    <nav>
        <ul>
            <li><a href="dean_homepage.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dean_homepage.php' ? 'active' : ''; ?>">Home</a></li>
            <li><a href="dean_myprofile.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dean_myprofile.php' ? 'active' : ''; ?>">My Profile</a></li>
            <li><a href="help_support_dean.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'help_support_dean.php' ? 'active' : ''; ?>">Help & Support</a></li>
