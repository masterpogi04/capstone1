        ...
        <div class="header">
            ...
            <div class="welcome-text">
                ...
                <nav class="admin-nav-grid">
                    <a href="instructor_incident_report.php" class="admin-nav-item">Submit Student Violation</a>
                    <a href="view_incident_reports.php" class="admin-nav-item">View Submitted Student Violation</a>
