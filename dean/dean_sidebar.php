...
// Fetch dean details from database
include '../db.php';
$stmt = $connection->prepare("SELECT username, first_name, middle_initial, last_name FROM tbl_dean WHERE id = ?");
if ($stmt === false) {
...
<div class="sidebar">
    <div class="profile-section text-center">
        ...
        <h4 class="dean-name"><?php echo htmlspecialchars($display_name); ?></h4>
    </div>
    <nav>
        <ul>
            <li>
            <a href="dean_homepage.php">
            <i class="fas fa-home"></i> Home</a>
        </li>
            <li>
            <a href="dean_myprofile.php">
            <i class="fas fa-user"></i> My Profile</a>
            </li>
        <li>
            <a href="help_support_dean.php">
            <i class="fas fa-question-circle"></i> Help & Support</a>
        </li>
            <li>
