...
if ($result->num_rows === 1) {
    ...
    $middle_initial = $adviser['middle_initial'];  // Add this line
...
$analytics_query = "
    SELECT 
        ...
        IFNULL(SUM(CASE WHEN s.gender = 'male' THEN 1 ELSE 0 END), 0) AS male_students,
        IFNULL(SUM(CASE WHEN s.gender = 'female' THEN 1 ELSE 0 END), 0) AS female_students
    FROM sections sec
